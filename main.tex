...
A commitment scheme allows one to commit to a chosen message while preventing them from changng the message after publishing the commitment. These commitments should not reveal anything about the chosen message.
