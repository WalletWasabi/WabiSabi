...
\begin{abstract}
  ...
  A number of methods have been proposed to create privacy. Among these, CoinJoin which is an approach to structure transactions which adds ambiguity and breaks common assumptions that underlie heuristics used for surveillance.
