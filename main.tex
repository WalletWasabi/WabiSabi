...
\author{Yuval Kogman, István András Seres, Ádám Ficsór}
\date{\today}
...
We define \emph{CoinJoin inefficiency} as the fraction of non-mixed change outputs in a CoinJoin transaction, see Figure~\ref{fig:cjinefficiency}.
