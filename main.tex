...
\begin{abstract}
  ...
  Earlier implementations of CoinJoin protocols present a number of limitations which may partly explain the lack of their widespread adoption.
